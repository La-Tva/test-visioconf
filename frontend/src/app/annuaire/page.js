    ...
    return (
        <div className={styles.container}>
            <div className={styles.directoryWrapper}>
                ...
                {/* CURRENT USER BANNER - NEW */}
                {currentUser && (
                    <div className={styles.userBanner}>
                        <div className={styles.bannerAvatarWrapper}>
                            <img 
                        ...
                        <div className={styles.bannerContent}>
                            ...
                            <Link href="/profile" className={styles.bannerActionBtn}>
                ...
                <div className={styles.grid}>
                    {filteredUsers.filter(u => currentUser && u._id !== currentUser._id).map(u => {
                        const isMe = currentUser && currentUser._id === u._id;
